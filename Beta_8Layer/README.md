# Beta LAYOUT PCB-POOL 8-Layer (ENIG) KiCad Template

KiCad project template for **Beta LAYOUT's PCB-POOL service**, an 8-layer FR4 board at
...
Copy the `Beta_8Layer/` directory into your user template path, then
...
## Stackup (8L, ~1.6 mm, ISOLA DE104, derived)

Material: **ISOLA DE104** (Tg 135 C), Dk at 1 GHz from the DE104 datasheet.

**Beta publishes no 8-layer stackup.** This is a symmetric build from ISOLA DE104
prepreg/core blocks (2116, 7628) summing to ~1.6 mm. Confirm with Beta before an
impedance-controlled order.

| Layer   | Construction | Thickness | Dk @ 1 GHz |
|---------|--------------|----------:|-----------:|
| F.Cu    | 35 um        | 0.035 mm  |            |
| Prepreg | 2116         | 0.12 mm   | 4.45       |
| In1.Cu  | 35 um        | 0.0152 mm |            |
| Core    | 2x7628       | 0.25 mm   | 4.67       |
| In2.Cu  | 35 um        | 0.0152 mm |            |
| Prepreg | 7628         | 0.20 mm   | 4.56       |
| In3.Cu  | 35 um        | 0.0152 mm |            |
| Core    | 2x7628       | 0.25 mm   | 4.67       |
| In4.Cu  | 35 um        | 0.0152 mm |            |
| Prepreg | 7628         | 0.20 mm   | 4.56       |
| In5.Cu  | 35 um        | 0.0152 mm |            |
| Core    | 2x7628       | 0.25 mm   | 4.67       |
| In6.Cu  | 35 um        | 0.0152 mm |            |
| Prepreg | 2116         | 0.12 mm   | 4.45       |
| B.Cu    | 35 um        | 0.035 mm  |            |
...
- Stackup is derived from ISOLA DE104 datasheet; Beta publishes no official 8L build.
