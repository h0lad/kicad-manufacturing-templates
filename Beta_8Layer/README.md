# Beta LAYOUT PCB-POOL 8-Layer (ENIG)
...
## Stackup (8L, 1.60 mm, derived)

Beta publishes no 8-layer stackup. This is a symmetric build from ISOLA DE104
prepreg/core blocks (2116, 7628) summing to ~1.6 mm; confirm with Beta before
an impedance-controlled order.
