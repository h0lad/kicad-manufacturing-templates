# Beta LAYOUT PCB-POOL 6-Layer (ENIG) KiCad Template

KiCad project template for **Beta LAYOUT's PCB-POOL service**, a 6-layer FR4 board at
...
Copy the `Beta_6Layer/` directory into your user template path, then
...
## Stackup (Beta PCB-POOL 6L, ~1.6 mm, ISOLA DE104)
...
- Beta "Lagenaufbau Multilayer 6 Lagen 1,6 mm" stackup page.
