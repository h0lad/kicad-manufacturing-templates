# AISLER 8-Layer 35µm ENIG KiCad Template

KiCad project template matching **AISLER's 8-layer 35 µm copper, ENIG** design rules
...
(1080/2116 prepreg + FR-4 core), **Peters Elpemer AS 2467 SM-DG** soldermask (Dk 3.7).
3-core build with 1080/2116/1080 prepreg sandwiches. (July 2025.)

Files are KiCad 8 format; KiCad 10 opens and migrates them on first save.

## Installation

Copy the `Aisler_8Layer/` directory into your user template path, then
...
[8-layer 1.6 mm stackup](https://community.aisler.net/t/8-layers-1-6mm-35-m-stackup/5459) —
a 3-core build; the two inner prepreg groups are 1080/2116/1080 sandwiches:

| Ref  | Layer                 | Thickness        | er            |
|------|-----------------------|-----------------:|---------------|
| TOP  | Copper                | 35 µm            |               |
|      | Prepreg 1080 ×2       | 2 × 70 µm        | 4.0           |
| IN1  | Copper                | 35 µm            |               |
|      | Core FR-4             | 200 µm           | 4.4           |
| IN2  | Copper                | 35 µm            |               |
|      | Prepreg 1080/2116/1080| 70 + 115 + 70 µm | 4.0/4.25/4.0  |
| IN3  | Copper                | 35 µm            |               |
|      | Core FR-4             | 200 µm           | 4.4           |
| IN4  | Copper                | 35 µm            |               |
|      | Prepreg 1080/2116/1080| 70 + 115 + 70 µm | 4.0/4.25/4.0  |
...
- [AISLER 8-layer 1.6 mm stackup](https://community.aisler.net/t/8-layers-1-6mm-35-m-stackup/5459)
