# PCBWay 4-Layer FR-4 KiCad Template

KiCad project template matching **PCBWay's default online-quote settings** for a
standard FR-4 4-layer board -- the pre-selected, no-surcharge options on
...
Copy the `PCBWay_4Layer/` directory into your user template path, then
...
|---------|--------------------------|----------:|-------|
| F.Cu    | Cu 1 oz (0.5 base+plate) | 0.0350 mm | SIG   |
| Prepreg | 7628 RC46, Dk 4.74       | 0.1855 mm |       |
| In1.Cu  | Cu 1 oz                  | 0.0350 mm | GND   |
| Core    | FR-4, Dk 4.6             | 1.0300 mm |       |
| In2.Cu  | Cu 1 oz                  | 0.0350 mm | PWR   |
| Prepreg | 7628 RC46, Dk 4.74       | 0.1855 mm |       |
| B.Cu    | Cu 1 oz                  | 0.0350 mm | SIG   |

Plane plan SIG / GND / PWR / SIG. PCBWay's standard multilayer uses **1 oz inner copper**, so inner and outer
...
Impedance classes (outer-layer microstrip over In1/GND, 0.1855 mm 7628, Dk 4.74), via 0.6/0.3:

- Diff_90R_USB 0.266/0.266 mm, gap 0.2
- Diff_100R 0.214/0.214 mm, gap 0.2
- RF_50R (single-ended) 0.31 mm, clearance 0.3
