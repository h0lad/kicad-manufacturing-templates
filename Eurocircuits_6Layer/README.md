# Eurocircuits STANDARD Pool 6-Layer FR-4 KiCad Template
...
Copy the `Eurocircuits_6Layer/` directory into your user template path, then
...
- Inner annular ring >= 0.175 mm (IAR, class-6 min)
- Inner track width / spacing >= 0.15 mm (ITW / ITT-ITP-IPP)
