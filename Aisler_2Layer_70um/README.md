# AISLER 2-Layer 70µm ENIG KiCad Template

KiCad project template matching **AISLER's 2-layer 70 µm (2 oz) copper, ENIG**
design rules. Based on AISLER's official template ([github.com/AislerHQ/aisler-support](https://github.com/AislerHQ/aisler-support)).
70 µm copper on both sides, **ENIG** finish (Ni 4–7 µm, Au 0.05–0.1 µm), Panasonic
laminate with **Peters Elpemer AS 2467 SM-DG** soldermask (Dk 3.7). Heavier copper
means coarser track/space rules than the 35 µm variant. (July 2025.)

Files are KiCad 8 format; KiCad 10 opens and migrates them on first save.

## Installation

Copy the `Aisler_2Layer_70um/` directory into your user template path, then
...
|-------------------------------|----------|----------------------------------|------------|
| Min track width (global)      | 0.175 mm | min. tracewidth                  | 0.175 mm   |
| Min clearance (global)        | 0.175 mm | min. spacing copper/copper       | 0.175 mm   |
| Min via diameter (global)     | 0.45 mm  | min. via diameter (→ 0.25 drill) | 0.25 mm*   |
| Min via annular ring (global) | 0.175 mm | min. via annular ring            | 0.175 mm   |
...
0.175 (70 µm min) — 0.20 — 0.25 — 0.3 — 0.4 — 0.5 — 0.8 — 1.0 — 1.5 — 2.0 mm
...
- Default 0.20/0.175 mm, via 0.6/0.3
- Signal_Fine 0.175/0.175 mm (70 µm minimum), via 0.45/0.25
...
> 70 µm vs 35 µm ENIG: coarser track (0.175 vs 0.125 mm) and via ring (0.175 vs
> 0.10 mm). Use 35 µm for fine-pitch designs.
