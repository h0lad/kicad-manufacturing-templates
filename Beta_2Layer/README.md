# Beta LAYOUT PCB-POOL 2-Layer (ENIG) KiCad Template

KiCad project template for **Beta LAYOUT's PCB-POOL service**, a 2-layer FR4 board at
...
Copy the `Beta_2Layer/` directory into your user template path, then
...
2-layer boards are a single FR4 core. Beta supplies a finished thickness of
1.55 mm (+/-0.13). No reference plane -- controlled impedance is not practical on
this service.
