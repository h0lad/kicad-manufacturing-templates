# AISLER 2-Layer 70um HASL

Derived from AISLER's official 2-layer KiCad template (github.com/AislerHQ/aisler-support),
adjusted to the 70 um HASL rule set. Lead-free HASL, Panasonic laminate,
...
HASL vs ENIG on 2-layer: coarser copper (track 0.225 vs 0.125 mm ENIG) and larger
