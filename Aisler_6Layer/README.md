# AISLER 6-Layer 35µm ENIG KiCad Template

KiCad project template matching **AISLER's 6-layer 35 µm copper, ENIG** design rules
...
Symmetric 2-core build. (July 2025.)

Files are KiCad 8 format; KiCad 10 opens and migrates them on first save.

## Installation

Copy the `Aisler_6Layer/` directory into your user template path, then
...
[6-layer 1.6 mm stackup](https://community.aisler.net/t/6-layers-1-6mm-35-m-stackup/5458) —
a symmetric 2-core build (TOP..IN1 and IN4..BOT foils, cores carry IN1/IN2 and IN3/IN4):

| Ref  | Layer                 | Thickness        | er            |
|------|-----------------------|-----------------:|---------------|
| TOP  | Copper                | 35 µm            |               |
|      | Prepreg 2116 ×2       | 2 × 115 µm       | 4.25          |
| IN1  | Copper                | 35 µm            |               |
|      | Core FR-4             | 300 µm           | 4.5           |
| IN2  | Copper                | 35 µm            |               |
|      | Prepreg 2116 ×3       | 3 × 115 µm       | 4.25          |
| IN3  | Copper                | 35 µm            |               |
|      | Core FR-4             | 300 µm           | 4.5           |
| IN4  | Copper                | 35 µm            |               |
|      | Prepreg 2116 ×2       | 2 × 115 µm       | 4.25          |
...
- [AISLER 6-layer 1.6 mm stackup](https://community.aisler.net/t/6-layers-1-6mm-35-m-stackup/5458)
