# PCBWay 6-Layer FR-4 KiCad Template

KiCad project template matching **PCBWay's default online-quote settings** for a
standard FR-4 6-layer board -- the pre-selected, no-surcharge options on
...
Copy the `PCBWay_6Layer/` directory into your user template path, then
...
Plane plan SIG / GND / SIG / PWR / GND / SIG. PCBWay's standard multilayer uses **1 oz inner copper**, so inner and outer
