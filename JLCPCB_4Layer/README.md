...
Standard 4-layer **1.6 mm** FR-4, **JLC04161H-7628** stackup, **1oz outer /
0.5oz inner** copper, targeting JLCPCB's **no-extra-cost** capability envelope.
Refer to the [JLCPCB Capabilities](https://jlcpcb.com/capabilities/pcb-capabilities)
page and [order page](https://cart.jlcpcb.com/quote) for current specifications
and pricing. Values pulled July 2026.
...
| In2.Cu       | Cu 0.5 oz        | 0.0152 mm  |     | PWR    |
| Prepreg      | 7628, 21% RC     | 0.2104 mm  | 4.4 |        |
